...
from tf_keras.utils import normalize
...
# for binary crossEntropy, dense= 1, activation function: sigmoid
# for categorical crossEntryopy, dense = 2 , activation function: softmax
